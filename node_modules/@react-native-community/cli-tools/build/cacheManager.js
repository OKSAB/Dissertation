...
function removeProjectCache(name) {
  ...
  try {
    ...
    _logger.default.error(`Failed to remove cache for ${name}. If you experience any issues when running freshly initialized project, please remove the "${_chalk().default.unde